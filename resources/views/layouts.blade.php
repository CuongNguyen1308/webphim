...
<body class="home blog halimthemes halimmovies" data-masonry="">
                            ...
                            <div class="form-group">
                                <div class="input-group col-xs-12">
                                    <form action="{{ route('tim-kiem') }}" method="GET">
                                        <input type="text" id="timkiem" name="search" class="form-control"
    ...
    <script type='text/javascript' src='{{ asset('assets/js/bootstrap.min.js?ver=5.7.2') }}' id='bootstrap-js'></script>
    <script type='text/javascript' src='{{ asset('assets/js/owl.carousel.min.js?ver=5.7.2') }}' id='carousel-js'></script>
    ...
    <script type='text/javascript'>
        $(document).ready(function() {
            $('#timkiem').keyup(function() {
                ...
                if (search != "") {
                    var experssion = new RegExp(search, 'i');
                    $.getJSON('/json_file/movies.json', function(data) {
                        $.each(data, function(key, value) {
                            if (value.title.search(experssion) != -1 || value.description
                                .search(experssion) != -1 || value.name_eng.search(
                                    experssion) != -1
                            ) {
                                $('#result').css("display", "inherit");
                                $('#result').append(
                                    '<li style="cursor: pointer;" class="list-group-item link-class"><img src="/uploads/movie/' +
                                    value.image + '" alt="" width="50px">' + value
